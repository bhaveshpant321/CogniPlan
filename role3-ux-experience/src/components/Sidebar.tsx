...
import {
  ...
  LogOut, Moon, Sun, Zap, PanelLeftClose, PanelLeftOpen,
} from "lucide-react";
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-slate-700/50 h-16 shrink-0">
        <AnimatePresence>
          {isSidebarOpen && (
            ...
            >
              ...
              <span className="font-bold text-slate-100 whitespace-nowrap tracking-tight">
                StudySync
              </span>
            </motion.div>
          )}
        ...
        <button
          ...
          className="p-1.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-700 transition-colors shrink-0 ml-auto"
        >
      ...
      <div className="flex flex-col gap-1 px-3 py-3 border-t border-slate-700/50">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-800 transition-colors"
        >
          {isDarkMode
            ? <Sun  size={15} className="shrink-0 text-yellow-400" />
